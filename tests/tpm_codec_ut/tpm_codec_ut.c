...
BEGIN_TEST_SUITE(tpm_codec_ut)
    ...
    static void setup_tss_policy_secret_mocks(void)
    {
        ...
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        ...
        STRICT_EXPECTED_CALL(TPMS_AUTH_COMMAND_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(tpm_comm_submit_command(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(TPMI_ST_COMMAND_TAG_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
            .CopyOutArgumentBuffer_target(&expected_size, sizeof(expected_size));
        STRICT_EXPECTED_CALL(UINT32_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
            .CopyOutArgumentBuffer_target(&raw_resp, sizeof(raw_resp));
        STRICT_EXPECTED_CALL(TPM2B_DIGEST_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(TPMT_TK_AUTH_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    }
    ...
    static void setup_tss_start_auth_session_mocks(void)
    {
        ...
        STRICT_EXPECTED_CALL(TPM2B_DIGEST_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT8_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(TPMT_SYM_DEF_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        ...
        STRICT_EXPECTED_CALL(UINT32_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
            .CopyOutArgumentBuffer_target(&raw_resp, sizeof(raw_resp));
        STRICT_EXPECTED_CALL(TPM2B_DIGEST_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(MemoryCopy2B(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    }
    ...
    TEST_FUNCTION(Initialize_TPM_Codec_emulator_succeed)
    {
        ...
        STRICT_EXPECTED_CALL(tpm_comm_create(IGNORED_ARG));
        STRICT_EXPECTED_CALL(tpm_comm_get_type(IGNORED_ARG)).SetReturn(TPM_COMM_TYPE_EMULATOR);
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT16_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(UINT32_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    ...
    TEST_FUNCTION(Deinit_TPM_Codec_succeed)
    {
        ...
        STRICT_EXPECTED_CALL(tpm_comm_destroy(IGNORED_ARG));
    ...
    TEST_FUNCTION(TSS_create_persistent_key_success)
    {
        ...
        STRICT_EXPECTED_CALL(UINT32_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
            .CopyOutArgumentBuffer_target(&raw_resp, sizeof(raw_resp));
        STRICT_EXPECTED_CALL(TPM2B_PUBLIC_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(TPM2B_NAME_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(TPM2B_NAME_Unmarshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    ...
    TEST_FUNCTION(TSS_HMAC_succeed)
    {
        ...
        STRICT_EXPECTED_CALL(MemoryCopy(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));

        // TSS_MARSHAL_OPT2B
        STRICT_EXPECTED_CALL(TPM2B_MAX_BUFFER_Marshal(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
